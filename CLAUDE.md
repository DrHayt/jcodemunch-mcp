...
## Current State
- **Version:** 1.98.0 (runtime trace ingestion: Phases 0-5)
- **INDEX_VERSION:** 16
- **Tests:** 4133 passed, 7 skipped (1.98.0)
- **Python:** >=3.10
