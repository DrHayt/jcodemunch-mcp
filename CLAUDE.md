...
## Current State
- **Version:** 1.103.0 (get_group_contracts: F-15 cross-repo API surface — GitNexus group_contracts parity, with intent classification + stability + runtime evidence)
- **INDEX_VERSION:** 16
- **Tests:** 4204 passed, 7 skipped (1.103.0)
- **Python:** >=3.10
